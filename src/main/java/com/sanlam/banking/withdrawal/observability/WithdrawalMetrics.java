...
public class WithdrawalMetrics {
    ...
    public WithdrawalMetrics(MeterRegistry registry, OutboxOperations outboxOperations) {
        ...
        registry.gauge("outbox.pending.count", outboxOperations, r -> (double) r.countPending());
        registry.gauge("outbox.pending.oldest.age.seconds", outboxOperations,
                r -> (double) r.oldestPendingAgeSeconds());
        registry.gauge("outbox.failed.count", outboxOperations, r -> (double) r.countFailed());
    }
